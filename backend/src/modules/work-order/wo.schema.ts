...
export const updateWoStatusSchema = z.object({
...
export const addWoItemSchema = z.object({
  type: z.enum(['jasa', 'sparepart']),
  sparepartId: z.number().int().positive().optional(),
  jasaId: z.number().int().positive().optional(),
...
export const updateWoItemSchema = z.object({
...
export const addWoStageSchema = z.object({
  nama: z.string().min(1, 'Nama tahap wajib diisi'),
...
export const updateWoStageSchema = z.object({
