    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/monitoring" className="p-2 hover:bg-surface-hover rounded-xl border border-surface-border glass transition-colors">
            <ArrowLeft size={20} />
          </Link>
          <div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="glass-panel p-6">
            ...
            <Link href="/spk/SPK-0046" className="w-full text-center block mt-4 text-sm border border-surface-border py-2 rounded-xl font-medium hover:bg-surface-hover transition-colors">
              Lihat Detail SPK
            </Link>
          </div>
