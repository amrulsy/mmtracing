          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-2">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <Link href="/pembayaran" className="text-xs text-primary font-medium hover:underline">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="mt-4 space-y-3">
                      ...
                      {/* DP minimum warning */}
                      {(selected.spk?.mode === 'modifikasi' || selected.spk?.mode === 'bubut') && selected.totalBayar === 0 && selected.spk?.minimumDp > 0 && (
                  ...
                  <div>
                    ...
                    <button onClick={handleBayar} disabled={processing || numBayar <= 0} className="w-full mt-6 btn-glossy bg-primary text-primary-foreground py-4 rounded-xl font-bold text-lg shadow-glossy-primary hover:shadow-glossy-primary-dark transition-all flex items-center justify-center gap-2 disabled:opacity-50">
                    ...
                    {sisa <= 0 && (
                      <Link
                        href={`/pembayaran/${selected.id}/kwitansi`}
          ...
          <div className="bg-background border border-surface-border rounded-2xl p-8 w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-200 text-center">
            ...
            <div className="flex flex-col gap-2">
              {showSuccessModal.isLunas && (
                <Link
                  href={`/pembayaran/${showSuccessModal.invoiceId}/kwitansi`}
