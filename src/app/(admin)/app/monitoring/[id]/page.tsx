...
export default function MonitoringDetailPage() {
 ...
 <button className="flex items-center gap-2 text-sm bg-emerald-500 text-white px-4 py-2 rounded-xl font-medium shadow-sm hover:bg-emerald-600 transition-colors ">
