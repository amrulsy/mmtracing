...
export default function MonitoringPage() {
 ...
 {columns.map((col, i) => (
 <button key={i} onClick={() => setActiveCol(i)} className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-medium whitespace-nowrap transition-all ${activeCol === i ? "bg-primary text-white " : "bg-surface border border-surface-border text-muted-foreground"}`}>
