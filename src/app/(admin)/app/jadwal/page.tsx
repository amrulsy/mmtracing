...
export default function JadwalPage() {
 ...
 <button onClick={openModal} className="flex items-center justify-center gap-1.5 bg-primary text-primary-foreground px-3 py-2 rounded-xl text-sm font-medium hover:">
 ...
 className="flex-1 bg-primary text-white py-2 rounded-xl font-bold text-sm hover: flex items-center justify-center gap-1.5 disabled:opacity-60">
