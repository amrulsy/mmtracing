...
export function WoPhotos({ photos, onUpload, uploading }: SpkPhotosProps) {
 ...
 <img src={p.url} alt={p.caption || "Lampiran Work Order"} className="w-full h-full object-cover transition-transform group-hover:scale-105" />
 {p.caption && (
