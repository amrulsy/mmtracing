...
export function EditWoModal({ spk, editForm, setEditForm, editSaving, onClose, onSave }: EditSpkModalProps) {
 return (
 ...
 <h3 className="font-bold flex items-center gap-2"><Edit size={16} /> Edit Work Order</h3>
