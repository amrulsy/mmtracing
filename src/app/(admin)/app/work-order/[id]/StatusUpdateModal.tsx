...
export function StatusUpdateModal({
 ...
 <span className="font-semibold text-foreground">{spk.noWo}</span> dari{" "}
 ...
 <p className="mt-0.5">Mengembalikan Work Order dari <strong>selesai</strong> akan mempengaruhi garansi &amp; perolehan poin loyalty pelanggan. Operasi ini dibatalkan jika invoice sudah <strong>lunas</strong>.</p>
 </div>
 </div>
 )}
