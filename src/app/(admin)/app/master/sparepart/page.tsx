...
export default function SparepartPage() {
 ...
 <Link href="/app/master/sparepart/tambah" className="flex items-center justify-center gap-1.5 bg-primary text-primary-foreground px-3 py-2 rounded-xl text-sm font-medium hover:">
