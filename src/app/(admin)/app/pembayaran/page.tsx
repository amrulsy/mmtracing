                  ...
                  return (
                    <tr key={item.id} className="bg-surface hover:bg-surface-hover/50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right space-x-2">
                        {item.status !== "lunas" && (
                          <Link href={`/app/pembayaran/kasir?id=${item.id}`} className="px-3 py-1.5 text-xs font-medium rounded-lg bg-primary text-white shadow-sm hover:shadow-glossy-primary">Bayar</Link>
                        )}
