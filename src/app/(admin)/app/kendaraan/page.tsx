...
export default function KendaraanPage() {
 ...
 const isAdmin = hasAccess("master", "full"); // Changed from roleName === "Admin"
 ...
 <div className={`w-10 h-10 rounded-full overflow-hidden flex items-center justify-center text-sm font-bold flex-shrink-0 ${selected === i ? 'bg-primary text-primary-foreground ' : 'bg-surface-border text-muted-foreground'}`}>
 {p.photoUrl ? (
 ...
 <div className="w-16 h-16 rounded-2xl overflow-hidden bg-primary text-primary-foreground flex items-center justify-center text-2xl font-bold flex-shrink-0">
 {active.photoUrl ? (
 // eslint-disable-next-line @next/next/no-img-element
 ...
 <button type="submit" disabled={editLoading} className="px-5 py-2 text-sm font-bold bg-primary text-primary-foreground rounded-xl hover: transition-all disabled:opacity-70">
 ...
 <button type="submit" disabled={editKenLoading} className="px-5 py-2 text-sm font-bold bg-primary text-primary-foreground rounded-xl hover: transition-all disabled:opacity-70">
 ...
 <button type="submit" disabled={addKenLoading} className="px-5 py-2 text-sm font-bold bg-primary text-primary-foreground rounded-xl hover: transition-all disabled:opacity-70">
