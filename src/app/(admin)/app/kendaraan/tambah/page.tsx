...
export default function TambahKendaraanPage() {
 ...
 <button type="submit" disabled={loading} className="px-6 py-2.5 text-sm font-bold bg-primary text-primary-foreground rounded-xl hover: transition-all flex items-center gap-2 disabled:opacity-70">
