    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      ...
      <div className="space-y-2">
        {error ? (
          ...
          return (
            <Link key={insp.id} href={`/app/inspeksi/${insp.id}`} className="glass-panel p-4 flex items-center gap-4 hover:-translate-y-0.5 hover:shadow-glossy transition-all block">
