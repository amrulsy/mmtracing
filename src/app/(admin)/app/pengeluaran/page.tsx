...
export default function PengeluaranPage() {
 ...
 <button
 onClick={openAdd}
 className="flex items-center justify-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-xl font-medium hover:"
 >
 ...
 className="w-full mt-2 py-2.5 bg-primary text-white font-bold rounded-xl disabled:opacity-50 flex justify-center items-center gap-2 hover:"
 >
