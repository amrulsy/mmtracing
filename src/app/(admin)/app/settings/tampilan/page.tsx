...
export default function TampilanPage() {
 ...
 className={`p-3 lg:p-4 rounded-xl border-2 cursor-pointer transition-all text-center ${themeMode === t.value ? "border-primary bg-primary/5 " : "border-surface-border hover:border-primary/30"}`}
 >
 ...
 <button onClick={handleSave} className="flex items-center gap-1.5 bg-primary text-primary-foreground px-4 py-2 rounded-xl text-sm font-medium ">
