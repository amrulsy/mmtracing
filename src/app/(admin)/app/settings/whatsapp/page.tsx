...
export default function WhatsAppSettingsPage() {
 ...
 required
 />
 <button disabled={sendingTest || !testPhone || !testMessage} type="submit" className="flex items-center justify-center gap-1.5 bg-primary text-primary-foreground px-4 py-2 rounded-xl text-sm font-medium hover: disabled:opacity-50">
 ...
 className={`px-3 py-1.5 text-xs font-medium rounded-lg whitespace-nowrap transition-colors ${activeTab === tab.id ? "bg-primary text-primary-foreground " : "bg-surface-hover text-muted-foreground hover:bg-surface-border"}`}
 >
 {tab.label}
 </button>
 ))}
