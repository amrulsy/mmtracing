...
export default function SettingsPage() {
 ...
 if (role === "sa") return "bg-blue-500/10 text-blue-600 border-blue-500/20";
 if (role === "kasir") return "bg-emerald-500/10 text-emerald-600 border-emerald-500/20";
 if (role === "mekanik") return "bg-amber-500/10 text-amber-600 border-amber-500/20";
 ...
 <button onClick={openAddUser} className="flex items-center gap-1.5 bg-primary text-primary-foreground px-3 py-2 rounded-xl text-xs font-medium hover:">
 <Plus size={14} /> Tambah
 </button>
 </div>
 ...
 <button onClick={saveGeneral} disabled={savingGeneral || loading} className="flex items-center gap-1.5 bg-primary text-primary-foreground px-4 py-2 rounded-xl text-sm font-medium hover: disabled:opacity-50">
 ...
 <div className="mt-4 flex justify-end">
 <button onClick={saveProfile} disabled={saving || loading} className="flex items-center gap-1.5 bg-primary text-primary-foreground px-4 py-2 rounded-xl text-sm font-medium hover: disabled:opacity-50">
 ...
 <button type="submit" disabled={submitting} className="w-full mt-2 py-2.5 bg-primary text-white font-bold rounded-xl disabled:opacity-50 flex justify-center items-center gap-2 ">
